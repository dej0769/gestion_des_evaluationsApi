package com.example.Gestion_des_evaluations.Subject.Controller;
...
import com.example.Gestion_des_evaluations.Subject.Service.SujetExamenService;
...
@RestController
@RequestMapping("/api/sujets-examen")
public class SujetExamenController {
    ...
    public List<SujetExamenResponseDTO> getByModule(@PathVariable String module) {
        return sujetExamenService.getByModule(module);
    }
}